...
class DefaultGeminiService(
    ...
    private val contents = mutableListOf(
        Content(role = Content.Role.USER, listOf(Part(INITIAL_CONTEXT + "그리고 응답을 영어로 바꿔줘"))),
    )
